						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Liquids</a></li>
									<li><a data-toggle="tab" href="#tab1">Tablets</a></li>
									<li><a data-toggle="tab" href="#tab1">Capsules</a></li>
									<li><a data-toggle="tab" href="#tab1">Drops</a></li>
								</ul>
							</div>
						</div>
					</div> -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Liquids</a></li>
									<li><a data-toggle="tab" href="#tab2">Tablets</a></li>
									<li><a data-toggle="tab" href="#tab2">Capsules</a></li>
									<li><a data-toggle="tab" href="#tab2">Drops</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/pproduct05.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
